...
# create a new list that is sorted using a built-in function
print('original nums list:\n', nums)
sorted_nums = sorted(nums, reverse=True)  # reverse is used if we want highest to lowest
print(f'new sorted nums:\n {sorted_nums}')
print()

# sort the list "in-place" using a list method
print('original nums list:\n', nums)
